...
(function () {
    ...
    function initMagnetic() {
        ...
        const PULL = 0.5;      // how much of the cursor offset the button follows
        const MAX_PULL = 26;   // px cap so it never drifts too far
        const LIFT = -8;       // matches the existing hover lift baseline
